...
if ((!isset($_SESSION['id'])) && (!isset($_SESSION['pass'])) or isset($_POST['logout'])) {
    session_unset();
    session_destroy();
...
if (isset($_POST['btnupdate'])) {
    ...
    $update = "UPDATE `admin` SET `id`='$id',`pass`='$pass' WHERE count=$_GET[edit]";
...
if (isset($_GET['edit'])) {
    $sel = "select * from admin where count=$_GET[edit]";
...
if (isset($_GET['del'])) {
    echo $_GET['del'];
    $del = "DELETE FROM `admin` WHERE count=$_GET[del]";
...
<body>
    <div class="m-lg-4">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link fw-bold" href="login.php">User Data</a>
            </li>
            <li class="nav-item">
                ...
                <form id="addAdminForm" method="POST">
                    <div class="form-group mb-4">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="adminId" name="id" value="<?php if (isset($_GET['edit']))
                                echo $row['id'] ?>" placeholder="Enter Admin ID" required>
                        </div>
                    </div>
                    <div class="form-group mb-4">
                        <div class="input-group">
                            <span class="input-group-text bg-primary text-white"><i class="fa fa-lock"></i></span>
                            <input type="password" class="form-control" id="password" name="pass" value="<?php if (isset($_GET['edit']))
                                echo $row['pass'] ?>" placeholder="Enter Password" required>
                        </div>
                    </div>
        ...
        <table id="myTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="admin.php?edit=<?PHP echo $row['count']; ?>"
                            class="btn btn-outline-warning btn-sm"><span class="fa fa-edit"></span></a>
                        <a href="admin.php?del=<?PHP echo $row['count']; ?>"
